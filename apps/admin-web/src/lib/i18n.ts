...
const EN = {
    ...
    signUpNudge: "New to CareOS?",
    signUpTitle: "Set up your agency",
    haveAccount: "Already have an account?",
    stepOf: "Step {current} of {total}",
    stepAgencyLabel: "Agency",
    stepServiceLabel: "Services",
    stepAccountLabel: "Your account",
    stepAgencyTitle: "Which agency is this?",
    stepAgencySubtitle:
      "The legal name on your licence, and the states you deliver care in. The states decide which EVV aggregator and which compliance rules apply to you, so they are not a preference.",
    stepServiceTitle: "What do you deliver, and who pays for it?",
    stepServiceSubtitle:
      "Both shape the compliance rules applied to every visit. Publicly-funded payers require a cleared OIG/GSA exclusion check before a caregiver can be assigned.",
    stepAccountTitle: "Your owner account",
    stepAccountSubtitle:
      "This is the first account in your agency, and the only one that can invite the rest of your team.",
    agencyLegalName: "Legal name",
    agencyLegalNameHint: "As it appears on your state licence, not a trading name.",
    statesLegend: "States you deliver care in",
    statesHint:
      "Two-letter codes. Choose every state you operate in — each one has its own EVV aggregator and its own rules. You can change this later in your agency settings.",
    serviceLinesLegend: "Service lines",
    serviceLinesHint: "Choose every line you are licensed for.",
    serviceLineHomeCare: "Home care",
    serviceLineHomeHealth: "Home health",
    serviceLineHospice: "Hospice",
    payerTypesLegend: "Payer types you accept",
    payerTypesHint:
      "Medicaid and Medicare visits are subject to EVV and to exclusion screening. Private pay is not.",
    ownerEmailLabel: "Work email",
    ownerEmailHint:
      "You will sign in with this. Use an address you can reach — it is how you get back into the account.",
    ownerPasswordLabel: "Password",
    ownerPasswordHint:
      "At least 12 characters. Your role requires an authenticator app as well, which you will set up straight after this.",
    confirmPasswordLabel: "Repeat password",
    reviewTitle: "What you are creating",
    continueStep: "Continue",
    backStep: "Back",
    createAgencyAction: "Create agency",
    signUpFailedTitle: "Could not create your agency",
    signUpErrorEmailTaken:
      "That email address already has a CareOS account. Sign in instead, or use another address.",
    signUpErrorInvalid: "Check the highlighted fields and try again.",
    signUpErrorPasswordMismatch: "The two passwords did not match.",
    signUpErrorPasswordShort: "Use at least 12 characters.",
    signUpErrorNoStates: "Choose at least one state.",
    signUpErrorNoServiceLines: "Choose at least one service line.",
    signUpErrorNoPayers: "Choose at least one payer type.",
    signUpErrorNoName: "Enter your agency's legal name.",
    signUpErrorRateLimited:
      "Too many sign-ups from this network. Wait a few minutes and try again.",
    signUpErrorUnavailable:
      "CareOS could not be reached. Nothing was created — please try again.",
    signUpErrorExpired: "That took a while, so we cleared the form. Please start again.",
    welcomeTitle: "Your agency is set up",
    welcomeBody:
      "One step left before you can use the rest of CareOS: your role requires an authenticator app. Set it up below, then invite your team from the Users screen.",

    // --- Agency suspended
    agencySuspendedTitle: "This agency's CareOS access is suspended",
    agencySuspendedBody:
      "Nobody at your agency can sign in, including the caregiver app. Contact CareOS support to resolve it.",

    // --- Platform operator console
    platformAppSubtitle: "CareOS operations",
    platformSignInTitle: "CareOS operator sign-in",
    platformSignInSubtitle:
      "For CareOS staff. Agencies sign in at the ordinary address — this console holds no agency's records.",
    platformSignInFailed: "That email and password did not match. Please try again.",
    platformSignInDisabled: "This operator account has been disabled.",
    platformNavFleet: "Agencies",
    platformNavOperators: "Operators",
    platformNavAudit: "Access log",
    platformNavSecurity: "Security",
    platformFleetTitle: "Agencies",
    platformFleetSubtitle:
      "Every agency on CareOS, worst first. Counts and status only — this console can reach no client, caregiver, or visit record.",
    platformScopeTitle: "What this console can see",
    platformScopeBody:
      "Operational counts and status per agency, and nothing else. The database role behind these screens holds no permission on any table containing patient or caregiver information, so a query for one fails rather than returning a row. Every screen you open is recorded in the access log.",
    platformTotalAgencies: "Agencies",
    platformSuspendedAgencies: "Suspended",
    platformCriticalExceptions: "Open critical exceptions",
    platformRejectedEvv: "Agencies with rejected EVV",
    platformStalledEvv: "Agencies with EVV waiting to send",
    platformColAgency: "Agency",
    platformColStates: "States",
    platformColPeople: "People",
    platformColSchedule: "Next 7 days",
    platformColEvv: "EVV",
    platformColExceptions: "Exceptions",
    platformColCredentials: "Credentials",
    platformColActivity: "Last sign-in",
    platformStatusActive: "Active",
    platformStatusSuspended: "Suspended",
    platformNoAgencies: "No agencies yet",
    platformNoAgenciesDetail: "The first agency to sign up will appear here.",
    platformOpenAgency: "Open",
    platformAgencySubtitle: "Operational state for one agency, and the two actions CareOS can take.",
    platformBackToFleet: "Back to agencies",
    platformSectionPeople: "People",
    platformSectionSchedule: "Schedule",
    platformSectionEvv: "EVV transmission",
    platformSectionCompliance: "Compliance",
    platformUsersActive: "Users able to sign in",
    platformUsersMissingMfa: "Privileged users without MFA",
    platformOwnerAdmins: "Owner/admins",
    platformCaregiversActive: "Active caregivers",
    platformClientsActive: "Active clients",
    platformVisitsNext7: "Visits scheduled",
    platformVisitsUnfilled: "Unfilled",
    platformEvvPending: "Waiting to send",
    platformEvvTransmitted: "Sent, not acknowledged",
    platformEvvAcknowledged: "Acknowledged",
    platformEvvRejected: "Rejected",
    platformEvvOldestPending: "Oldest waiting since {when}",
    platformEvvNothingPending: "Nothing waiting to send",
    platformCredentialsExpired: "Expired credentials",
    platformCredentialsExpiring: "Expiring within 30 days",
    platformExceptionsCritical: "Critical",
    platformExceptionsWarning: "Warning",
    platformExceptionsInfo: "Info",
    platformSuspendTitle: "Suspend this agency",
    platformSuspendBody:
      "Nobody at the agency will be able to sign in, every token already issued stops working, and caregivers cannot clock in. The reason you give is shown to them and written into their own audit trail.",
    platformSuspendReasonLabel: "Reason (shown to the agency)",
    platformSuspendAction: "Suspend agency",
    platformReinstateTitle: "Reinstate this agency",
    platformReinstateBody:
      "Access is restored immediately. The note is recorded in both audit trails alongside the original reason.",
    platformReinstateNoteLabel: "Note (recorded)",
    platformReinstateAction: "Reinstate agency",
    platformSuspendedSince: "Suspended {when}",
    platformSuspendedBecause: "Reason: {reason}",
    platformSuspendedNotice: "The agency has been suspended and told why.",
    platformReinstatedNotice: "The agency is back in service.",
    platformActionFailed: "That action could not be completed",
    platformOperatorsTitle: "CareOS operators",
    platformOperatorsSubtitle:
      "Who can open this console. Platform admins can suspend an agency; support can only read.",
    platformNoOperators: "No operators yet",
    platformNoOperatorsDetail:
      "The first operator is created with database access, not from this screen.",
    platformOperatorRoleAdmin: "Platform admin",
    platformOperatorRoleSupport: "Platform support",
    platformAddOperator: "Add an operator",
    platformAddOperatorSubtitle: "They sign in with the password you set, then must enrol an authenticator.",
    platformOperatorName: "Display name",
    platformOperatorPasswordHint:
      "At least 16 characters. This account can see every agency's operational state.",
    platformCreateOperator: "Create operator",
    platformOperatorCreated: "Operator added",
    platformOperatorCreatedNote: "They can sign in now and must enrol an authenticator first.",
    platformOperatorDisabled: "Operator disabled",
    platformOperatorDisabledNote: "Their sessions stopped working on the next request they made.",
    platformOperatorEnabled: "Operator enabled",
    platformOperatorEnabledNote: "Sessions ended earlier stay ended.",
    platformDisableOperator: "Disable",
    platformEnableOperator: "Enable",
    platformOperatorAdminOnly: "Platform admins only",
    platformOperatorReadOnlyNote: "Your role can see who has access but not change it.",
    platformMfaNotEnrolled: "Authenticator not set up",
    platformNeverSignedIn: "Never signed in",
    platformLastSignIn: "Last signed in {when}",
    platformAuditTitle: "Access log",
    platformAuditSubtitle:
      "Every action and every screen an operator opened, newest first. Readable by both roles on purpose: a log only its authors can read is one nobody independent checks.",
    platformAuditEmpty: "Nothing recorded yet",
    platformColWhen: "When",
    platformColWho: "Who",
    platformColAction: "Action",
    platformColSubject: "Subject",
    platformSecuritySubtitle:
      "Multi-factor authentication for your operator account. It is required — there is no setting that turns it off.",
    platformMfaRequiredNote:
      "Set up an authenticator to use the console. Until you do, this is the only screen you can reach.",
    platformCouldNotLoad: "Could not load the operator console.",
    platformSystem: "CareOS",
...
const ES: Record<StringKey, string> = {
    ...
    signUpNudge: "¿Es nuevo en CareOS?",
    signUpTitle: "Configure su agencia",
    haveAccount: "¿Ya tiene una cuenta?",
    stepOf: "Paso {current} de {total}",
    stepAgencyLabel: "Agencia",
    stepServiceLabel: "Servicios",
    stepAccountLabel: "Su cuenta",
    stepAgencyTitle: "¿De qué agencia se trata?",
    stepAgencySubtitle:
      "El nombre legal de su licencia y los estados donde presta servicios. Los estados determinan qué agregador de EVV y qué reglas de cumplimiento se le aplican, así que no son una preferencia.",
    stepServiceTitle: "¿Qué servicios presta y quién los paga?",
    stepServiceSubtitle:
      "Ambos determinan las reglas de cumplimiento que se aplican a cada visita. Los pagadores con fondos públicos exigen una verificación de exclusión OIG/GSA aprobada antes de poder asignar a un cuidador.",
    stepAccountTitle: "Su cuenta de propietario",
    stepAccountSubtitle:
      "Es la primera cuenta de su agencia y la única que puede invitar al resto de su equipo.",
    agencyLegalName: "Nombre legal",
    agencyLegalNameHint: "Tal como aparece en su licencia estatal, no un nombre comercial.",
    statesLegend: "Estados donde presta servicios",
    statesHint:
      "Códigos de dos letras. Seleccione todos los estados en los que opera — cada uno tiene su propio agregador de EVV y sus propias reglas. Puede cambiarlo después en la configuración de su agencia.",
    serviceLinesLegend: "Líneas de servicio",
    serviceLinesHint: "Seleccione todas las líneas para las que tiene licencia.",
    serviceLineHomeCare: "Cuidado en el hogar",
    serviceLineHomeHealth: "Salud en el hogar",
    serviceLineHospice: "Cuidados paliativos",
    payerTypesLegend: "Tipos de pagador que acepta",
    payerTypesHint:
      "Las visitas de Medicaid y Medicare están sujetas a EVV y a la verificación de exclusión. El pago privado no.",
    ownerEmailLabel: "Correo de trabajo",
    ownerEmailHint:
      "Con este correo iniciará sesión. Use una dirección a la que tenga acceso — es la forma de recuperar la cuenta.",
    ownerPasswordLabel: "Contraseña",
    ownerPasswordHint:
      "Al menos 12 caracteres. Su función también requiere una aplicación de autenticación, que configurará justo después.",
    confirmPasswordLabel: "Repita la contraseña",
    reviewTitle: "Lo que va a crear",
    continueStep: "Continuar",
    backStep: "Atrás",
    createAgencyAction: "Crear agencia",
    signUpFailedTitle: "No se pudo crear su agencia",
    signUpErrorEmailTaken:
      "Ese correo ya tiene una cuenta en CareOS. Inicie sesión o use otra dirección.",
    signUpErrorInvalid: "Revise los campos indicados e inténtelo de nuevo.",
    signUpErrorPasswordMismatch: "Las dos contraseñas no coinciden.",
    signUpErrorPasswordShort: "Use al menos 12 caracteres.",
    signUpErrorNoStates: "Seleccione al menos un estado.",
    signUpErrorNoServiceLines: "Seleccione al menos una línea de servicio.",
    signUpErrorNoPayers: "Seleccione al menos un tipo de pagador.",
    signUpErrorNoName: "Escriba el nombre legal de su agencia.",
    signUpErrorRateLimited:
      "Demasiados registros desde esta red. Espere unos minutos e inténtelo de nuevo.",
    signUpErrorUnavailable:
      "No se pudo contactar con CareOS. No se creó nada — inténtelo de nuevo.",
    signUpErrorExpired: "Pasó demasiado tiempo y se borró el formulario. Empiece de nuevo, por favor.",
    welcomeTitle: "Su agencia está lista",
    welcomeBody:
      "Falta un paso para poder usar el resto de CareOS: su función requiere una aplicación de autenticación. Configúrela abajo y luego invite a su equipo desde la pantalla de Usuarios.",

    agencySuspendedTitle: "El acceso de esta agencia a CareOS está suspendido",
    agencySuspendedBody:
      "Nadie de su agencia puede iniciar sesión, incluida la aplicación para cuidadores. Comuníquese con el soporte de CareOS para resolverlo.",

    platformAppSubtitle: "Operaciones de CareOS",
    platformSignInTitle: "Acceso de operadores de CareOS",
    platformSignInSubtitle:
      "Para el personal de CareOS. Las agencias inician sesión en la dirección habitual — esta consola no contiene los registros de ninguna agencia.",
    platformSignInFailed: "El correo y la contraseña no coinciden. Inténtelo de nuevo.",
    platformSignInDisabled: "Esta cuenta de operador ha sido desactivada.",
    platformNavFleet: "Agencias",
    platformNavOperators: "Operadores",
    platformNavAudit: "Registro de acceso",
    platformNavSecurity: "Seguridad",
    platformFleetTitle: "Agencias",
    platformFleetSubtitle:
      "Todas las agencias de CareOS, las más críticas primero. Solo conteos y estado — esta consola no puede acceder a ningún registro de cliente, cuidador o visita.",
    platformScopeTitle: "Qué puede ver esta consola",
    platformScopeBody:
      "Conteos operativos y estado por agencia, y nada más. La función de base de datos detrás de estas pantallas no tiene permiso sobre ninguna tabla con información de pacientes o cuidadores, por lo que una consulta de ese tipo falla en lugar de devolver una fila. Cada pantalla que abre queda registrada en el registro de acceso.",
    platformTotalAgencies: "Agencias",
    platformSuspendedAgencies: "Suspendidas",
    platformCriticalExceptions: "Excepciones críticas abiertas",
    platformRejectedEvv: "Agencias con EVV rechazado",
    platformStalledEvv: "Agencias con EVV pendiente de envío",
    platformColAgency: "Agencia",
    platformColStates: "Estados",
    platformColPeople: "Personas",
    platformColSchedule: "Próximos 7 días",
    platformColEvv: "EVV",
    platformColExceptions: "Excepciones",
    platformColCredentials: "Credenciales",
    platformColActivity: "Último acceso",
    platformStatusActive: "Activa",
    platformStatusSuspended: "Suspendida",
    platformNoAgencies: "Aún no hay agencias",
    platformNoAgenciesDetail: "La primera agencia que se registre aparecerá aquí.",
    platformOpenAgency: "Abrir",
    platformAgencySubtitle:
      "Estado operativo de una agencia y las dos acciones que CareOS puede tomar.",
    platformBackToFleet: "Volver a agencias",
    platformSectionPeople: "Personas",
    platformSectionSchedule: "Horario",
    platformSectionEvv: "Transmisión de EVV",
    platformSectionCompliance: "Cumplimiento",
    platformUsersActive: "Usuarios que pueden iniciar sesión",
    platformUsersMissingMfa: "Usuarios privilegiados sin MFA",
    platformOwnerAdmins: "Propietarios/administradores",
    platformCaregiversActive: "Cuidadores activos",
    platformClientsActive: "Clientes activos",
    platformVisitsNext7: "Visitas programadas",
    platformVisitsUnfilled: "Sin cubrir",
    platformEvvPending: "Pendiente de envío",
    platformEvvTransmitted: "Enviado, sin acuse",
    platformEvvAcknowledged: "Con acuse",
    platformEvvRejected: "Rechazado",
    platformEvvOldestPending: "El más antiguo espera desde {when}",
    platformEvvNothingPending: "No hay nada pendiente de envío",
    platformCredentialsExpired: "Credenciales vencidas",
    platformCredentialsExpiring: "Vencen en 30 días",
    platformExceptionsCritical: "Críticas",
    platformExceptionsWarning: "Advertencias",
    platformExceptionsInfo: "Informativas",
    platformSuspendTitle: "Suspender esta agencia",
    platformSuspendBody:
      "Nadie de la agencia podrá iniciar sesión, todos los tokens ya emitidos dejan de funcionar y los cuidadores no podrán registrar su entrada. El motivo que indique se les muestra y queda escrito en su propio registro de auditoría.",
    platformSuspendReasonLabel: "Motivo (se muestra a la agencia)",
    platformSuspendAction: "Suspender agencia",
    platformReinstateTitle: "Reactivar esta agencia",
    platformReinstateBody:
      "El acceso se restablece de inmediato. La nota queda registrada en ambos registros de auditoría junto al motivo original.",
    platformReinstateNoteLabel: "Nota (queda registrada)",
    platformReinstateAction: "Reactivar agencia",
    platformSuspendedSince: "Suspendida el {when}",
    platformSuspendedBecause: "Motivo: {reason}",
    platformSuspendedNotice: "La agencia ha sido suspendida y se le informó del motivo.",
    platformReinstatedNotice: "La agencia vuelve a estar en servicio.",
    platformActionFailed: "No se pudo completar esa acción",
    platformOperatorsTitle: "Operadores de CareOS",
    platformOperatorsSubtitle:
      "Quién puede abrir esta consola. Los administradores de plataforma pueden suspender una agencia; el personal de soporte solo puede leer.",
    platformNoOperators: "Aún no hay operadores",
    platformNoOperatorsDetail:
      "El primer operador se crea con acceso a la base de datos, no desde esta pantalla.",
    platformOperatorRoleAdmin: "Administrador de plataforma",
    platformOperatorRoleSupport: "Soporte de plataforma",
    platformAddOperator: "Agregar un operador",
    platformAddOperatorSubtitle:
      "Iniciará sesión con la contraseña que establezca y luego deberá configurar una aplicación de autenticación.",
    platformOperatorName: "Nombre visible",
    platformOperatorPasswordHint:
      "Al menos 16 caracteres. Esta cuenta puede ver el estado operativo de todas las agencias.",
    platformCreateOperator: "Crear operador",
    platformOperatorCreated: "Operador agregado",
    platformOperatorCreatedNote:
      "Ya puede iniciar sesión y primero deberá configurar una aplicación de autenticación.",
    platformOperatorDisabled: "Operador desactivado",
    platformOperatorDisabledNote:
      "Sus sesiones dejaron de funcionar en la siguiente solicitud que hicieron.",
    platformOperatorEnabled: "Operador activado",
    platformOperatorEnabledNote: "Las sesiones cerradas anteriormente siguen cerradas.",
    platformDisableOperator: "Desactivar",
    platformEnableOperator: "Activar",
    platformOperatorAdminOnly: "Solo administradores de plataforma",
    platformOperatorReadOnlyNote: "Su función permite ver quién tiene acceso, pero no modificarlo.",
    platformMfaNotEnrolled: "Sin aplicación de autenticación",
    platformNeverSignedIn: "Nunca inició sesión",
    platformLastSignIn: "Último acceso el {when}",
    platformAuditTitle: "Registro de acceso",
    platformAuditSubtitle:
      "Cada acción y cada pantalla que abrió un operador, las más recientes primero. Legible por ambas funciones a propósito: un registro que solo sus autores pueden leer es uno que nadie independiente revisa.",
    platformAuditEmpty: "Aún no hay nada registrado",
    platformColWhen: "Cuándo",
    platformColWho: "Quién",
    platformColAction: "Acción",
    platformColSubject: "Sujeto",
    platformSecuritySubtitle:
      "Autenticación de múltiples factores para su cuenta de operador. Es obligatoria — no hay ninguna opción que la desactive.",
    platformMfaRequiredNote:
      "Configure una aplicación de autenticación para usar la consola. Hasta entonces, esta es la única pantalla a la que puede acceder.",
    platformCouldNotLoad: "No se pudo cargar la consola de operadores.",
    platformSystem: "CareOS",
